...
const SERVICES = [
  { id: 'growth-engine',  icon: Rocket,      label: 'Starter Growth Engine',    desc: 'Offer + positioning + 30-day plan',           price: 'From $199' },
  { id: 'messenger-sales',icon: Megaphone,    label: 'Messenger Sales Machine',  desc: 'WhatsApp/Messenger funnel + scripts',          price: 'From $299' },
  { id: 'booked-calls',   icon: Target,       label: 'Booked Calls Funnel',      desc: 'Lead gen → calls → pipeline system',           price: 'From $399' },
  { id: 'creative-sprint',icon: Palette,      label: 'Creative Sprint Pack',     desc: 'Ads, graphics, copy — full creative bundle',   price: 'From $149' },
  { id: 'ai-sales',       icon: Bot,          label: 'AI Sales Assistant',       desc: 'AI-powered follow-up + lead qualification',    price: 'From $249' },
  { id: 'copy',           icon: FileText,     label: 'Copywriting Pack',         desc: 'Landing page, emails, ad scripts',             price: 'From $129' },
  { id: 'custom',         icon: Briefcase,    label: 'Custom Request',           desc: 'Describe what you need — we will scope it',    price: 'Request quote' },
]
