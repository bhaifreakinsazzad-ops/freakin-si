...
const partners: Partner[] = [
  ...
  },
  {
    ...
    name: 'Not Real Engine Marketing',
    tagline: 'Full-Service Digital Marketing Agency',
    tags: ['Digital Marketing', 'Web Development', 'SEO', 'Social Media'],
    description:
      'A full-service digital marketing partner that helps new businesses build a powerful online presence from day one. From paid advertising to organic SEO, professional web development to compelling copywriting, the team handles every channel that drives customer acquisition.',
    services: [
    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-6 pt-20 pb-10 text-center">
        ...
        >
          ...
          <p className="text-lg max-w-2xl mx-auto" style={{ color: 'var(--fsi-text-muted, #9ca3af)' }}>
            Expert services integrated directly into your Not Real Engine journey — available at exactly
            ...
            {[
              {
                ...
                detail: 'Use the builder to map your business strategy step by step.',
                color: '#F5B041',
              },
              {
                step: '02',
      ...
      >
        ...
        <p className="mb-8 text-lg" style={{ color: 'var(--fsi-text-muted, #9ca3af)' }}>
          Your partners are waiting inside the builder — start your blueprint today.
        </p>
        <Link
          to="/builder"
